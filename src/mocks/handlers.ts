...
export const handlers = [
	http.get('/api/courses', () => {
		return HttpResponse.json({
			courses: [
				{ id: '8b8afe1b-449b-4cce-b108-8dd8eef4648e', name: 'COMP SCI 2103' },
				{ id: '35dcf831-4888-475a-a172-7842ae3c526e', name: 'COMP SCI 1104' },
				{ id: '33254151-e980-4727-882c-4bece847fdab', name: 'MATHS 1004' },
			],
		});
	}),
