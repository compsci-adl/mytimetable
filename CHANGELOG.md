...
- Bump vitest from 4.1.8 to 4.1.11 ([#124](https://github.com/compsci-adl/mytimetable/pull/124))

## [3.4.2] - 2026-09-07

### Package Updates

- Chore(deps): lock file maintenance ([#123](https://github.com/compsci-adl/mytimetable/pull/123))

## [3.4.1] - 2026-09-05

### Package Updates

- Bump pnpm from 11 to 12 ([#122](https://github.com/compsci-adl/mytimetable/pull/122))

## [3.4.0] - 2026-09-05

### Fixed

- Fix: .ics Import Failure ([#120](https://github.com/compsci-adl/mytimetable/pull/120))

## [3.3.0] - 2026-09-05

### Added

- Feat: Display course level and unit value ([#119](https://github.com/compsci-adl/mytimetable/pull/119))

## [3.2.9] - 2026-08-31

### Package Updates

- Chore(deps): lock file maintenance ([#121](https://github.com/compsci-adl/mytimetable/pull/121))

## [3.2.8] - 2026-08-24

### Package Updates

- Chore(deps): lock file maintenance ([#118](https://github.com/compsci-adl/mytimetable/pull/118))

## [3.2.7] - 2026-08-17

### Package Updates

- Chore(deps): lock file maintenance ([#117](https://github.com/compsci-adl/mytimetable/pull/117))

## [3.2.6] - 2026-08-15

### Package Updates

- Chore(deps): lock file maintenance ([#113](https://github.com/compsci-adl/mytimetable/pull/113))
...
- Add class groups support. Ensures that you can only select classes in the same group for the course. ([#104](https://github.com/compsci-adl/mytimetable/pull/104))

## [3.1.1] - 2026-07-08

### Added

- Feat: Use new method for changelog CI workflow ([#103](https://github.com/compsci-adl/mytimetable/pull/103))

### Changed

- Chore: Update changelog for version 3.1.0 with weekend classes support ([#103](https://github.com/compsci-adl/mytimetable/pull/103))

## [3.1.0] - 2026-07-08

### Added

- Support weekend classes ([#102](https://github.com/compsci-adl/mytimetable/pull/102))
